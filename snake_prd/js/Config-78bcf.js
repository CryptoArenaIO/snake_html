 ...
 * @LastEditors: hjy 545925654@qq.com
 * @LastEditTime: 2025-04-11 13:56:49
 */


var game_version = "V_0411_01";
...
var address2 = "https://snake.queenarena.io"//外网-sn-web地址 (线上正式) 
...
var address1 = "https://snake.queengame.io"//外网-sn-web地址 (线上正式) 
    ...
    async function copyLogsToClipboard() {
        try {
            ...
            const logText = logs.map(log => {
                return `[${log.timestamp}] ${log.type.toUpperCase()}: ${log.data.map(item => {
